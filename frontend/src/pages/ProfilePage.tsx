          ...
          {isEditing ? (
            <>
              <button
                ...
                style={{ background: isDark ? '#374151' : '#F3F4F6', color: isDark ? '#F9FAFB' : '#1C1C1A', border: 'none', borderRadius: '10px', padding: '10px 20px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
              >
                <X size={16} /> Cancel
              </button>
              <button
                onClick={handleSave}
                style={{ background: '#1D9E75', color: '#fff', border: 'none', borderRadius: '10px', padding: '10px 20px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
              >
            ...
            <button
              ...
              style={{ background: '#0097A7', color: '#fff', border: 'none', borderRadius: '10px', padding: '10px 20px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
            >
        ...
        <div>
          <div style={sectionStyle}>
            ...
            <div style={{ position: 'relative', width: '120px', height: '120px', margin: '0 auto 20px' }}>
              <div style={{
                ...
                fontSize: '48px', color: '#fff', fontFamily: "'DM Serif Display', serif",
            ...
            <div style={{ textAlign: 'center', marginBottom: '24px' }}>
              {isEditing ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <input style={{ ...inputStyle, textAlign: 'center', fontSize: '18px', fontWeight: 600 }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)'}`, paddingTop: '20px' }}>
              ...
              <div>
                ...
                <div style={infoStyle}><Hash size={16} color="#0097A7" /> {profile.username || '—'}</div>
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <div style={infoStyle}><MapPin size={16} color="#0097A7" /> {profile.address || '—'}</div>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  <input style={inputStyle} type="number" value={profile.age ?? ''} onChange={e => setProfile({ ...profile, age: parseInt(e.target.value) || null })} />
                ) : (
                  <div style={infoStyle}><User size={16} color="#0097A7" /> {profile.age ? `${profile.age} years old` : '—'}</div>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  <input style={inputStyle} type="date" value={profile.birthday} onChange={e => setProfile({ ...profile, birthday: e.target.value })} />
                ) : (
                  <div style={infoStyle}><Calendar size={16} color="#0097A7" /> {profile.birthday || '—'}</div>
                )}
              </div>
          ...
          <div style={{ ...sectionStyle, padding: '16px' }}>
            <button
              ...
              style={{ width: '100%', padding: '12px', borderRadius: '10px', border: 'none', background: 'transparent', color: '#EF4444', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', transition: 'background 0.2s' }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div
                  ...
                  style={{ width: '40px', height: '20px', background: profile.notifications ? '#0097A7' : (isDark ? '#374151' : '#E5E7EB'), borderRadius: '20px', position: 'relative', cursor: 'pointer', transition: 'background 0.2s' }}>
                  <div style={{ position: 'absolute', left: profile.notifications ? '22px' : '2px', top: '2px', width: '16px', height: '16px', background: '#fff', borderRadius: '50%', transition: 'left 0.2s' }} />
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div
                  ...
                  style={{ width: '40px', height: '20px', background: profile.privacyMode ? '#0097A7' : (isDark ? '#374151' : '#E5E7EB'), borderRadius: '20px', position: 'relative', cursor: 'pointer', transition: 'background 0.2s' }}>
                  <div style={{ position: 'absolute', left: profile.privacyMode ? '22px' : '2px', top: '2px', width: '16px', height: '16px', background: '#fff', borderRadius: '50%', transition: 'left 0.2s' }} />
                </div>
              </div>
            </div>
          </div>
